        ...
        public async Task<IActionResult> CreateForum(ForumModel forumDetails, List<IFormFile> files)
        {
            ...
            if (user != null)
            {
                ...
                if (files != null && files.Count > 0)
                {
                 ...
                 using (var amazonS3client = new AmazonS3Client("ASIA55H4D3RU3MHBU7NT", "s2O9QjPY+WI35FRv/JxWBOAb+s2lnHKaeU1B2Fbh", "", RegionEndpoint.USEast1))
                    {
